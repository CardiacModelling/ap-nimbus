...
The |client-direct| component stores user log-ins and stores simulations users have run, CellML files and Pk data files users
...
``1docker inspect ap_nimbus_data`` where ``ap_nimbus_data`` is the name of the data volume and look for the path specified as
`Mountpoint`.
