...
const defaultApiUrlAppManager: string = '__api_url_appmgr';
const defaultApiUrlData: string = '__api_url_data';
...
export class SimulationRestApiImpl implements SimulationService {
  ...
  constructor(//private envService: EnvService,
    ...
    if (envApiUrlAppMgr != '' && envApiUrlAppMgr != defaultApiUrlAppManager) {
      this.appManagerUrl = envApiUrlAppMgr;
    }
    let envApiUrlData: string = envService.apiUrlData;
    if (envApiUrlData != '' && envApiUrlData != defaultApiUrlData) {
